...
const linksData: { [key: string]: React.ReactNode } = {
    ...
    sabaagh_shatir: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ شاطر - صباغ ممتاز - <b>صباغ الكويت</b> - 51108895
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
                <b>صباغ الكويت</b> يوفر لكم كل هذه الاشياء في عمله فان خبرته تجعله افضل صباغ حيث انه يعمل بأفضل الخامات عليه الجودة الذي تجعل عمليه الدهان تتم على اكمل وجه كما يتميز بانه يمتلك فريق عمل متخصص ويجعله يتمم المهمة في اسرع وقت كما يتميز <b>صباغ الكويت</b> بانه يوفر لكم ارخص الاسعار داخل دولة الكويت ويتبع الطرق الحديثة في عمليات الدهان ودائما ما يسعى لتطوير الخدمات التي يقدمها من اجل ارضاء العملاء
            </Typography>
    ...
    sabaagh_alkuayt: (
        <Stack alignItems="center" spacing={2}>
            {/* <Image src={sabaagh_alkuayt} alt="<b>صباغ الكويت</b>" objectFit="contain" height={400} /> */}
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
    ...
    faniy_sabagh: (
        <Stack alignItems="center" spacing={2}>
            <Stack spacing={2} alignItems="center">
                <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                    فني صباغ - <b>صباغ الكويت</b> - 51108895
                </Typography>
                <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
            ...
            <Stack spacing={2} alignItems="center">
                <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                    صباغ -<b>صباغ الكويت</b>
                </Typography>
                <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
                    يعتبر صباغ من اهم الكلمات المستخدمة في مجال ا<b>صباغ الكويت</b> وتعني دهانات المنازل والشقق والقسائم وعمل ديكورات في البيوت وتصميم رسومات في شقق الاطفال داخل دولة الكويت تعتبر الصباغة جزءًا مهمًا لتجديد المنازل والمباني. في الكويت، هناك شركات متخصصة تقدم خدمات صباغة متنوعة. هذه الشركات تستخدم تقنيات حديثة ومواد عالية الجودة لتحقيق أفضل النتائج. تشمل خدمات الصباغة في الكويت صباغة داخلية وخارجية، ورق جدران، وحل مشاكل الجدران. الصباغ المحترف في الكويت يركز على السلامة ويعد المكان جيدًا قبل البدء بالعمل. 80% من الأفراد يشعرون بالسعادة بعد تغيير لون منازلهم. تحسين مظهر المنزل يمكن أن يزيد من قيمته. لذلك، اختيار شركة صباغة محترفة مهم للحصول على أفضل النتائج بأسعار معقولة.
                </Typography>
                <Divider component="div" orientation="horizontal" sx={{ width: '30%' }} />
            </Stack>
        </Stack>
    ...
    sabaagh_buyut_aitfal: (
        <Stack alignItems="center" spacing={2}>
            <Typography variant="h1" textAlign={"center"} fontWeight={500} fontSize={30} color="primary.main">
                صباغ بيوت أطفال - 51108895
            </Typography>
            <Typography textAlign="center" fontSize={18} color="text.secondary" width={{ xs: "auto", md: "80%" }}>
                صباغ بيوت هو افضل خدمة صباغ يقدمها <b>صباغ الكويت</b> في البيوت جميع انواع الدهانات المطفية والزيتة اذا كنت تبحث عن افضل و احدث تصميمات الثري دى التي اصبحت من احدث الصيحات فى مجال الديكورات. فان <b>صباغ الكويت</b> يمتلك باقة من الالبومات التي تضم افضل رسومات ورق الجدران التى تتناسب مع كل اذواق و اراء عملاء <b>صباغ الكويت</b>. ليس فقط الرسومات عزيزى العميل و لكن ايضا الجودة و السعر ف<b>صباغ الكويت</b> يوفر لك ورق الجدار بالشكل الذى تريده و كذلك بافضل جودة و اعلي مستوى و ايضا اقل سعر. يقدم <b>صباغ الكويت</b> جبس بورد باشكال متعددة تتميز بالروعة و الجمال و كذلك تصميمات داخلية و خارجية من الجبس بورد و التى يتم صناعتها على ايدى نخبة من افضل المهندسين و الفنيين المختصين ذوى الخبرة الطويلة فى هذا المجال. مع استخدام افضل الخامات للحصول على اعلى جودة ممكنة للجبس بورد ف<b>صباغ الكويت</b> يسعلى دائما للتميز و الجودة و ارضاء كل العملاء .
            </Typography>
            <Divider component="div" orientation="horizontal" sx={{ width: '30%' }} />
        </Stack>
    ),
